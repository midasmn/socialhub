...
<html lang="<?=$lang?>">
  <head>
	...
	<!-- <meta property="og:image" content="<?=$sns_url?>" /> -->
	<meta property="og:image" content="http://faceapglezon.info/ogimage/icalendar.php?url=<?php echo $_SERVER["HTTP_HOST"] . $_SERVER["REQUEST_URI"].'&ad=1';?>" />
