...
$target_page = isset($_GET['target_page']) ? $_GET['target_page'] : 'list.php';
...
$keywords = "";
$description = "";
$h1_index = ($search_tag=="" ? '<i class="fa fa-picture-o" aria-hidden="true"></i>画像一覧':'<i class="fa fa-picture-o" aria-hidden="true"></i>'.$search_tag.':画像一覧');
